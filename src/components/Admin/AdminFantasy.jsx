...
*/
    ...
    const handleInputChange = (event) => {
        ...
        if (name === 'gameweek') {
            ...
            const updatedTeamsData = formData
                .teamsData
                .map((team) => {
    ...
    const handleFantasySettingsUpdate = () => {
        ...
        axios
            .post(`https://pendel-server.onrender.com/Fantasy/AdminFantasySettings`, {
    ...
    const handlePlayersPointsUpdate = () => {
        //alert("points update");
        axios
            .post(`https://pendel-server.onrender.com/Fantasy/AdminPointsUpdate`, {
            leagueChoice: props.leagueChoice,
    ...
    return (
        <div
            ...
            {!isLoading && ( <> <div className="adminform">
                <div className="form-column">
                    <form >
                        ...
                        <Button className="btnSave" onClick={handlePlayersPointsUpdate}>שמור ניקוד
                        </Button>
                        <div
                            style={{
                            fontSize: '1rem',
                            ...
                            color: 'red'
                        }}>לשים לב: הניקוד שנשמר בלחיצה הוא הניקוד למחזור המצוין ב-gameweek</div>
                    </form>
                </div>
            ...
            </div> < BackToHomePage style = {{position:'absolute', top:'5.5%', right:'3%', width:'4.5%',  
